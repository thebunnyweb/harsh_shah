...
const CharacterFormComponent = ({state, submitForm, handleChange}) => {
    ...
    return (
        ...
        <div className="form-group" >
          ...
          {state.formErrors && state.formErrors.name && (<p>{state.formErrors.name}</p>) }
          </div>
        </div>
        <div className="form-group">
          ...
          { state.speciesData && state.speciesData.map((item,i)=><option value={item} key={i}>{item}</option>) }
            
          </select>
          <div className="invalid-feedback">
          {state.formErrors && state.formErrors.species && (<p>{state.formErrors.species}</p>) }
          </div>
        </div>
        <div className="form-group">
          ...
          {state.formErrors && state.formErrors.gender && (<div className="text-danger"><small>{state.formErrors.gender}</small></div>) }
        </div>
        <div className="form-group">
          ...
          />
          <div className="invalid-feedback">
          {state.formErrors && state.formErrors.homeworld && (<p>{state.formErrors.homeworld}</p>) }
          </div>
        </div>
        <button
          type="submit"
